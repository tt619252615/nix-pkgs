{ lib, stdenv, fetchFromGitHub, buildPythonPackage, substituteAll,
...
# propagates
more-itertools, numba, numpy, triton, tiktoken, torch, tqdm,
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ more-itertools numba numpy tiktoken torch tqdm ]
    ++ lib.optionals (lib.meta.availableOn stdenv.hostPlatform triton)
    [ triton ];
